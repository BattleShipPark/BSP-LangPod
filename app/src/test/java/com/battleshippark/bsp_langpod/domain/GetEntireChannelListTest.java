...
//        assertThat(dbChannelRealmList.get(0).getId()).isEqualTo(1);
//        assertThat(dbChannelRealmList.get(0).getTitle()).isEqualTo("title1");
//        assertThat(dbChannelRealmList.get(1).getId()).isEqualTo(2);
//        assertThat(dbChannelRealmList.get(1).getDesc()).isEqualTo("desc2");
